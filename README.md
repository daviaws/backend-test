...
### 5 - Sua aplicação deve ter o endpoint DELETE `/user/me` (feito)
...
**[Será validado que é possível excluir meu usuário com sucesso]** (feito)
...
**[Será validado que não é possivel excluir meu usuário com token inválido]** (feito)

Se o token for inválido o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![Deletar com token inválido](./public/deletarcomtokeninvalido.png)

**[Será validado que não é possivel excluir meu usuário sem o token]** (feito)
...
### 7 - Sua aplicação deve ter o endpoint GET `/post` (feito)
...
**[Será validado que é possível listar blogpost com sucesso]** (feito)
...
**[Será validado que não é possível listar blogpost sem token]** (feito)

Se não conter o token o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost sem token ](./public/listarpostsemtoken.png)

**[Será validado que não é possível listar blogpost com token inválido]** (feito)

Se o token for inválido o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/listarposttokeninvalido.png)

### 8 - Sua aplicação deve ter o endpoint GET `post/:id` (feito)
...
**[Será validado que é possível listar um blogpost com sucesso]** (feito)
...
**[Será validado que não é possível listar um blogpost sem token]** (feito)

Se não conter o token o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/listaumpostsemtoken.png)

**[Será validado que não é possível listar um blogpost com token inválido]** (feito)

Se o token for inválido o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/listaumposttokeninvalido.png)

**[Será validado que não é possível listar um blogpost inexistente]** (feito)
